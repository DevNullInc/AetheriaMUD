...
// All constants, #defines, and enums from mud.hpp that do not collide with type definitions
...
#define BV30 (1 << 30)
#define BV31 (1 << 31)
// ...all other #defines from mud.hpp...

// Non-colliding enums
// Example:
typedef enum { SUN_DARK, SUN_RISE, SUN_LIGHT, SUN_SET } sun_positions;
typedef enum { SKY_CLOUDLESS, SKY_CLOUDY, SKY_RAINING, SKY_LIGHTNING } sky_conditions;
typedef enum { SEX_NEUTRAL, SEX_MALE, SEX_FEMALE } sex_types;
// ...all other non-colliding enums from mud.hpp...
