...
3.  Use `insert_edit_into_file` with the code you want to change and the surrounding context from the `read_file` output.

This approach is particularly useful for large files where you only need to modify a small portion of the code.
